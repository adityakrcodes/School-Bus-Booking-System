...
<head>
    ...
    <title>Admin Dashboard | Delete a route</title>
</head>
<body>
<?php
    ...
    <section id="home-hero">
        <div class="home-hero-container">
            ...
            <div class="form-cont" style="margin-top:0;">
                ...
                <form action="delete-route-func.php" method="POST">
                    <?php
                        $sql = "SELECT * FROM routes";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo "<label for='route_id'>Select a route to delete</label>";
                            echo "<select name='route_id' id='route_id'>";
                            while($row = $result->fetch_assoc()) {
                                echo "<option value='".$row["route_id"]."'>".$row["origin"]." to ".$row["destination"]."</option>";
                            }
                            echo "</select>";
                        } else {
                            echo "0 results";
            ...
            <div class="user-info route-btns">
                ...
                <a href="add-route.php" class="btn">Add a route</a>
            </div>
        </div>
    </section>
